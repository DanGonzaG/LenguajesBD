...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="/">Edilit </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="../Controller/LibrosController.php">Libros</a></li>
                            <li><a class="dropdown-item" href="../Controller/CategoriasController.php">Categoría</a></li>
                            <li><a class="dropdown-item" href="../Controller/EditorialesController.php">Editoriales</a></li>
                        </ul>
                    </li>
                </ul>
                <form class="d-flex">
